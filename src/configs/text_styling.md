# Fable Bot — Text Styling Standards (The Swarm Terminal - OwO Style with ●)
...
### 1.2 Separator (`●`)
The status emoji and the username are separated by a filled circle bullet `●` with single spaces on either side.
